"""
Django settings for openpit project.
...
SECRET_KEY = 'django-insecure-04x$#v9pa6kpq=9sg(1xp%ejaa@f=f*3ekaq23^p4!v9v5^hgg'
...
WSGI_APPLICATION = 'openpit.wsgi.application'
...
# https://stackoverflow.com/questions/53250766/geodjango-on-heroku
